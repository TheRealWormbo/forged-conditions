...
/**
 * Adds Neoforge codec conversion for the OR condition, which has a direct equivalent in Neoforge. Any unsupported
 * conditions are dropped, but the potentially empty OR condition is returned anyway in such cases, along with a log
 * warning.
 */
...
public abstract class OrResourceConditionMixin implements ConvertibleCondition {
	...
	public LoadCondition forgedconditions_convert() {
		...
		return new OrLoadCondition(children);
	}
}
